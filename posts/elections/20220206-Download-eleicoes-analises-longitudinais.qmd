...
eu disponibilizo uma função exemplo para gerar as *urls* que armazenam as tabelas 
do portal para mais de um ano eleitoral. 

Note que a função monta as *urls* para tabelas de eleitorado, de detalhes da votação
...
nominal por seção eleitoral, seguem o mesmo padrão e podem ser podem substituir
